...
public interface KhachHangRepository extends JpaRepository<KhachHang,Integer> {
    ...
    Page<KhachHang> findAllByAddressContainingOrBirthDayContainingOrNameContainingOrPhoneNumberContainingOrCmndContainingOrEmailContainingOrCodeContaining
            (String address, String birthDay, String name, String phoneNumber, String cmnd, String email, String code, Pageable pageable);
}
