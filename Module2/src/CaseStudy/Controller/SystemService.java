...
public class SystemService {
    ...
    protected File addHouse(File file) throws IOException {
        String name;
        double serviceArea;
        double servicePrice;
        int maxPeople;
    ...
    protected File addRoom(File file) throws IOException {
        String name;
        double serviceArea;
        double servicePrice;
        int maxPeople;
    ...
    protected File addVilla(File file) throws IOException {
        String name;
        double serviceArea;
        double servicePrice;
        int maxPeople;
    ...
    protected void showService() throws IOException {
    ...
    protected void createObjRoom(ArrayList<String> listRoom) {
        Room room = new Room();
    ...
    protected void createObjHouse(ArrayList<String> listHouse) {
        House house = new House();
    ...
    protected void createObjVilla(ArrayList<String> listVilla) {
        Villa villa = new Villa();
